...
export function Footer() {
  return (
    <footer className="w-full bg-gradient-to-b from-background to-primary/5 pt-16 pb-8 mt-24 border-t border-border/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          {/* Company Info */}
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="h-10 w-10 rounded-full bg-gradient-to-br from-primary to-primary-light" />
              <span className="text-2xl font-bold bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent">AyurSutra</span>
            </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link href="#demo" className="text-sm text-foreground/80 hover:text-primary transition-colors">
                  Demo
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link href="#support" className="text-sm text-foreground/80 hover:text-primary transition-colors">
                  Support
                </Link>
              </li>
              <li>
