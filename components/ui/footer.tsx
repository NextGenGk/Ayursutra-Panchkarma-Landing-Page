...
export function Footer() {
  return (
    <footer className="w-full bg-neutral-950/95 pt-12 pb-8 mt-16 rounded-t-2xl border-t border-white/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          {/* Company Info */}
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="h-8 w-8 rounded-full bg-gradient-to-br from-neutral-800 to-black" />
              <span className="text-xl font-bold text-white">AyurSutra</span>
            </div>
            <p className="text-sm text-neutral-300">
              Revolutionizing Panchakarma patient management with modern technology and ancient wisdom.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link href="#demo" className="text-sm text-neutral-300 hover:text-white transition-colors">
                  Demo
                </Link>
              </li>
              <li>
                <Link href="#changelog" className="text-sm text-neutral-300 hover:text-white transition-colors">
                  Changelog
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <Link href="/help-center" className="text-sm text-neutral-300 hover:text-white transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
                <Link href="/documentation" className="text-sm text-neutral-300 hover:text-white transition-colors">
                  Documentation
                </Link>
              </li>
              <li>
