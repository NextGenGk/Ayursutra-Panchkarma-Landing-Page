      ...
      <div className="space-y-6">
        <div className="prose prose-lg max-w-none">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named AyurSutra</li>
